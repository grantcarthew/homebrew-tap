class Start < Formula
  ...
  url "https://github.com/grantcarthew/start/archive/refs/tags/v0.0.2.tar.gz"
  sha256 "c4b3a38cfb81ef94f7112b96c90a7824802af3136325e712c8a1ec5ec8facc10"
  license "MIT"
  ...
  test do
    assert_match "0.0.2", shell_output("#{bin}/start --version")
  end
end
