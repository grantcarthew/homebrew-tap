class Start < Formula
  ...
  url "https://github.com/grantcarthew/start/archive/refs/tags/v0.7.1.tar.gz"
  sha256 "d5450f123e96d94877f8736f64d144609d301d317b56109fcc5dd83e369cb735"
  license "MPL-2.0"
  ...
  def install
    ...
    commit = "5c7ac69e48d0136f9be2f8862a753a4303246004"
  ...
  test do
    assert_match "0.7.1", shell_output("#{bin}/start --version")
  end
end
